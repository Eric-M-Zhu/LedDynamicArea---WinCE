================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : LedApp Project Overview
===============================================================================

The application wizard has created this LedApp application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your LedApp application.
...
LedApp.h
    ...
    project specific headers and declares the CLedAppApp application class.
...
LedAppDlg.h, LedAppDlg.cpp - the dialog
    These files contain your CLedAppDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named LedApp.pch and a precompiled types file named StdAfx.obj.
